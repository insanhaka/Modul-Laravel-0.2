...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h4>Ubah Data Role & Permission</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            name="name" placeholder="Nama Role" value="{!! $data->name !!}">
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($menus as $item )
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-{!! $item->uri !!}">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="create" name="access[]" value="{!! "/".Str::lower($item->uri).'/:'.$akses->id !!}" @if ($data->menu->contains('id',$item->id)) checked @endif>
